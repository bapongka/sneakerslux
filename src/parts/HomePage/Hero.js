        ...
        <div className="relative hero-image">
          ...
          <div className="overlay right-0 bottom-0 md:inset-0">
            <button
              ...
              data-content='<div class="w-screen pb-60 md:w-96 md:pb-60 relative z-50">
          ...
          <img src="./images/content/image-section-1.png" alt="hero 1" className="absolute inset-0 md:relative w-full h-full object-cover z-20 object-center" />
        </div>
      </div>
    </section>
  );
